...
<html lang="en">
  <head>
    <meta charset="utf-8">
     ...
     <link href="ourserveses/css/external.css" rel="stylesheet">
     <link href="ourserveses/css/style.css" rel="stylesheet">
          ...
          <div class="container">
            <div class="row mx-0">
              <div class="col-md-4 px-0">
                <h1 class="my-0"><span class="text-primary">Autism&ME,</span> Training to transform children’s lives</h1>
              </div>
            </div>
          </div>
        </div>
          ...
          <section class="container">
            <div class="row mx-0 align-items-center">
              ...
              <div class="col-md-6 col-lg-4 px-0">
                <h2 class="mt-0 wide-lg mb-5 mb-md-0" data-aos="fade-up">In Argentina,  <span class="text-primary">WHO and partner</span>Training (CST) programme.<br> <span class="text-primary">around</span></h2>
              </div>
          ...
          <div class="container">
            <div class="row mx-0 align-items-center">
              <div class="col-md-6 order-md-2 order-lg-1 col-lg-4 px-0">
                <h2 class="my-0 wide-lg float-md-right float-lg-none offset-lg-5 mb-5 mb-md-0" data-aos="fade-right">I <span class="text-primary">use</span>  is a long established fact that a reader</h2>
              </div>
        ...
        <section id="about" class="section pb-0">
          <section class="container">
            <div class="row mx-0 align-items-center">
              ...
              <a href= "about me/index.html"><button type="submit" class="btn" style="border-radius: 10%; margin: 100px;">take a look</button></a>
          ...
          <div class="container">
            ...
            <section class="section pb-0">
              <div class="row mx-0 align-items-center"  data-aos="fade-up">
                <div class="col-md-6 col-lg-4 px-0" data-aos="blur">
                  <a href="#"><figure class="hover"><img alt="" class="w-100" style="border-radius: 10px;" src="img/news/news.jpg"></figure></a>
                </div>
              ...
              <div class="row mx-0 align-items-center" style="margin-top: 30px; " data-aos="fade-up">
                <div class="col-md-6 col-lg-4 px-0" data-aos="blur">
                  <a href="#"><figure class="hover"><img alt="" style="border-radius: 10px;" class="w-100" src="img/news/news.jpg"></figure></a>
                </div>
                <div class="col-md-6 col-lg-4 mt-5 mt-md-0 px-sm-0 pl-md-30px pr-lg-30px">
                  <h4 class="my-0 mb-2"><a href="#">Top 20 Illustrations Winners: Academy</a></h4>
                  <p><a href="#" class="text-dark font-weight-bold">Illustration</a> / June 06, 2020</p>
                  ...
                  <div  class="col-lg-3 col-md-6">
                      <div class="footer-widget">
                          ...
                          <ul class="footer-socail-share">
                              ...
                              <li><a href="#" style="background-color: black;"><i style="color: white; "  class="icofont-skype"></i></a></li>
                              <li><a href="#" style="background-color: black;"><i style="color: white; "  class="icofont-twitter"></i></a></li>
                              <li><a href="#" style="background-color: black;"><i style="color: white; "  class="icofont-linkedin"></i></a></li>
                          </ul>
                      </div>
                  </div>
