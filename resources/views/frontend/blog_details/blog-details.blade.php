...
<body class="fixed-footer">
    ...
    <!-- Navbar -->
    <nav id="scrollspy" class="navbar navbar-desctop position-relative ">
        ...
        <div class="d-flex align-items-center position-relative overflow: hidden; w-100">
            ...
            <div class="container">
                <ul class="navbar-nav navbar-nav-desctop  d-none d-lg-block">
                    ...
                    <li><a class="nav-link" href="#work">Our service</a></li>
                                        ...
                                        <div class="accordion" id="accordionExample">
                                            ...
                                            <div class="accordion-item" data-aos="fade-up">
                                                <h2 class="accordion-header" id="headingTwo">
                                                    <button class="accordion-button faq-qustion collapsed"
