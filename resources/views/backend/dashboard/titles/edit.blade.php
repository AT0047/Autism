                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Edit - {{ $title->title }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action ="{{ route('titles.update', $title->id) }}" method ="POST"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('title', $title->title) }}" name="title"
                            ...
                            <div class="pl-lg-4 ">
                                <div class="form-group ">
                                    ...
                                    @enderror
                                    <textarea id="postContent" name="description" rows="19" class="form-control " placeholder="Enter Description Here">{{ old('description', $title->description) }}</textarea>
                                </div>
                            </div>
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="place" class ="form-control">
                                                ...
                                                <option value="home" {{$title->place == 'home' ? 'selected' : ''}}>Home</option>
                                                <option value="articles" {{$title->place == 'articles' ? 'selected' : ''}}>Articles</option>
                                            </select>
                                            @error('place')
                                                <div class="alert text-danger" style="font-weight: bold;">{{ $message }}
                                                </div>
                            ...
                            <div class="pl-lg-4 ">
                                ...
                                <div>
                                    <img width = "150" height = "100" src="{{ asset('dashboard/img/' . $title->photo) }}" />
                                </div>
                                @error('photo')
                                    <div class="alert text-danger" style="font-weight: bold;">{{ $message }}</div>
                                @enderror
