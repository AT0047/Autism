                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Edit - {{ $ourService->en_title }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('ar_title', $ourService->ar_title) }}" name="ar_title"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('en_title', $ourService->en_title) }}" name="en_title"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="editor-ar" name="ar_description" rows="6" class="form-control"
                                        placeholder="Enter Arabic description">{{ old('ar_description', $ourService->ar_description) }}</textarea>
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea id="editor-en" name="en_description" rows="6" class="form-control"
                                        placeholder="Enter English description">{{ old('en_description', $ourService->en_description) }}</textarea>
                                </div>
                                <div class="form-group">
